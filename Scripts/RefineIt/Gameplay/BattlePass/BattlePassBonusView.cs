...
{
    public class BattlePassBonusView : MonoBehaviour
    {
        ...
        public BattlePassBonusSubViewContainer BattlePassBonusSubViewContainer;

        public void SetTimer(string dayAndHoursToString)
        {
            _timer.text = dayAndHoursToString;
        }
