...
namespace Configs
{
    [CreateAssetMenu(fileName = "Coke", menuName = "RemoteLink/Complex/Coke", order = 0)]
    public class ComplexCokeConfigLinkRemote : ScriptableObject
    {
        [SerializeField] private ComplexCokeRemoteConfig _remoteConfig;
