...
namespace Configs
{
    [CreateAssetMenu(fileName = "HardResources", menuName = "RemoteLink/Complex/HardResources", order = 0)]
    public class ComplexHardResourcesConfigLinkRemote : ScriptableObject
    {
        [SerializeField] private ComplexHardResourcesRemoteConfig _remoteConfig;
