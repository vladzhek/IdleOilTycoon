...
namespace Configs
{
    [CreateAssetMenu(fileName = "MotorOil", menuName = "RemoteLink/Processing/MotorOil", order = 0)]
    public class ProcessingMotorOilConfigLinkRemote : ScriptableObject
    {
        [SerializeField] private ProcessingMotorOilRemoteConfig _remoteConfig;
