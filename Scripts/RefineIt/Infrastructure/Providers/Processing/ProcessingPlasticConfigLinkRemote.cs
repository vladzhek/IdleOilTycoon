...
namespace Configs
{
    [CreateAssetMenu(fileName = "Plastic", menuName = "RemoteLink/Processing/Plastic", order = 0)]
    public class ProcessingPlasticConfigLinkRemote : ScriptableObject
    {
        [SerializeField] private ProcessingPlasticOilRemoteConfig _remoteConfig;
