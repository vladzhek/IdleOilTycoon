...
namespace Configs
{
    [CreateAssetMenu(fileName = "Ethanol", menuName = "RemoteLink/Processing/Ethanol", order = 0)]
             public class ProcessingEthanolConfigLinkRemote : ScriptableObject
             {
                 [SerializeField] private ProcessingEthanolRemoteConfig _remoteConfig;
