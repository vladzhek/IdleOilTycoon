...
namespace Configs
{
    [CreateAssetMenu(fileName = "Diesel", menuName = "RemoteLink/Processing/Diesel", order = 0)]
    public class ProcessingDieselConfigLinkRemote : ScriptableObject
    {
        [SerializeField] private ProcessingDieselRemoteConfig _remoteConfig;
