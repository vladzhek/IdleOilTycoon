...
namespace Configs
{
    [CreateAssetMenu(fileName = "Olefin", menuName = "RemoteLink/Processing/Olefin", order = 0)]
    public class ProcessingOlefinConfigLinkRemote : ScriptableObject
    {
        [SerializeField] private ProcessingOlefinRemoteConfig _remoteConfig;
