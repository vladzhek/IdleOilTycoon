...
namespace Configs
{
    [CreateAssetMenu(fileName = "Coke", menuName = "RemoteLink/Processing/Coke", order = 0)]
    public class ProcessingCokeConfigLinkRemote : ScriptableObject
    {
        [SerializeField] private CokeProcessingRemoteConfig _remoteConfig;
